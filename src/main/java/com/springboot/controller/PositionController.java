...
public class PositionController {
	...
	public String editPosition(@Valid @ModelAttribute("position") PositionEntity editPosition, BindingResult bindingResult, Model model) {
		if (bindingResult.hasErrors()) {
			model.addAttribute("editPositionSuccessful", false);
			return "edit-position";
		}
		try {
			repositoryService.updatePosition(editPosition);
			model.addAttribute("editPosition", editPosition);
