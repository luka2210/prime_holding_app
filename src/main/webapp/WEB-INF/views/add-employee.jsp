...
<body>
	...
	<form:form action="/employees/add-employee" method="POST" modelAttribute="employee">
		...
		<form:label path="dateOfBirth"> Date of birth: </form:label> <form:input type="date" path="dateOfBirth" value="1999-10-22" max="2005-12-31" min="1923-01-01"/> <form:errors path="dateOfBirth" cssClass="error"/> <br>
