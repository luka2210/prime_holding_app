	...
	<form:form action="/tasks/add-task" method="POST" modelAttribute="task">
		...
		<form:label path="id"> Assign employee: </form:label>
			<form:select path="employeeId">
				<form:options items="${allEmployees }" itemValue="id" itemLabel="fullNameAndId"/>
			</form:select> <br>
		<form:label path="completed"> Completed? </form:label> 
			<form:checkbox checked="true" id="checkboxCompleted" onclick="hideCompletionDateInput()" path="completed"/> <br>
